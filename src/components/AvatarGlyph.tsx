 ...
 *
 * Elle a porté trois habits en trois relevés, et c'est le troisième qui
 * tient :
 *
 ...
 *   3. l'ENCRE SEULE — « enlève le contour bleu de l'avatar sur l'accueil ».
 *
 * Le contour est donc parti, et avec lui la mécanique qu'il demandait : on
 * peignait la MÊME forme deux fois, en bleu grossie de son trait puis en
 * encre par-dessus, parce qu'un filet suivi sur une forme pleine épaissit
 * ses parties fines — ici les trois lignes de la fiche, qui se soudaient en
 * un pâté. Un seul tracé suffit désormais, et l'icône pèse ce qu'il faut :
 * l'encre du thème a déjà le poids d'un bouton.
 *
 * « Encre du thème » et non un noir en dur : sur fond sombre, un noir figé
 * disparaîtrait.
 */
