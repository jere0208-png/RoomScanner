    ...
    <Modal
      ...
      <View style={s.voile}>
        <Pressable
          ...
          accessibilityLabel="Profiter de -20 %"
          ...
          <ContourOr rayon={24} fond="#FFFFFF">
            <View style={s.carte}>
              <Image
                ...
                resizeMode="contain"
              />
              <TexteOr texte="Surprise !" taille={24} fond="#FFFFFF" />
              <Text style={s.corps}>
                Pour votre première souscription, EchoPlan Pro est à −20 % :
                {` ${prixRemise(20)} / mois`} au lieu de {PRIX_PRO}.
              </Text>
              {/* L'affordance du geste : un bouton dessiné — mais c'est
                  toute la carte qui répond, on ne peut pas le rater. */}
              <View style={s.cta}>
                <Text style={s.ctaTexte}>
                  Profiter de −20 % — code {CODE_BIENVENUE}
                </Text>
              </View>
              <Pressable
                accessibilityRole="button"
